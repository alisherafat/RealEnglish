...
public class TinyDB {
    ...
    private static SharedPreferences preferences = MyApp.getInstance().getSharedPreferences("RealEnglish", 0);
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";


    /**
     * Decodes the Bitmap from 'remotePath' and returns it
     *
     * @param path image remotePath
     * @return the Bitmap from 'remotePath'
     */
    ...
    /**
     * Returns the String remotePath of the last saved image
     *
     * @return string remotePath of the last saved image
     */
     ...
     *
     * @param theFolder    the folder remotePath dir you want to save it to e.g "DropBox/WorkImages"
     * @param theImageName the name you want to assign to the image file e.g "MeAtLunch.png"
     * @param theBitmap    the image you want to save as a Bitmap
     * @return returns the full remotePath(file system address) of the saved image
     */
     ...
     *
     * @param fullPath  full remotePath of the image file e.g. "Images/MeAtLunch.png"
     * @param theBitmap the image you want to save as a Bitmap
    ...
    /**
     * Creates the remotePath for the image with name 'imageName' in DEFAULT_APP.. directory
     *
     * @param imageName name of the image
     * @return the full remotePath of the image. If it failed to create directory, return empty string
     */
    ...
    /**
     * Saves the Bitmap as a PNG file at remotePath 'fullPath'
     *
     * @param fullPath remotePath of the image file
    ...
    public static String getString(String key, String dafaultValue) {
        return preferences.getString(key, dafaultValue);
    }
...
//    }
    ...
    /**
     * Delete image file at 'remotePath'
     *
     * @param path remotePath of image file
